...
export function About() {
  ...
  return (
    <section id="about" className="relative overflow-hidden border-t border-[#f5f1e8]/8 py-20 lg:py-24">
      <CrackLines variant={1} />
      <div
        ref={containerRef}
        className="relative mx-auto grid max-w-[1600px] grid-cols-1 gap-10 px-6 lg:grid-cols-2 lg:gap-16 lg:px-14"
      >
