    ...
    <section id="results" className="py-24 lg:py-32">
      <div ref={containerRef} className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 lg:grid-cols-[1.3fr_1fr] lg:grid-rows-2">
          <div
            data-reveal
            className="flex flex-col justify-center rounded-2xl border border-[#c9a24b]/25 bg-[#12100d] p-8 lg:row-span-2 lg:p-10"
          >
          ...
          {OUTCOMES.map(({ icon: Icon, title, body }) => (
            <div key={title} data-reveal className="rounded-2xl border border-[#f5f1e8]/10 bg-[#12100d] p-7">
